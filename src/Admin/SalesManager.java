...
public class SalesManager extends javax.swing.JFrame {
     ...
     */
    public SalesManager(String identifier) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 324, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalesManager("exampleEmployeeID:SalesManager").setVisible(true);
            }
        });
    }
