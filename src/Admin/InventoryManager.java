...
public class InventoryManager extends javax.swing.JFrame {
     ...
     */
    public InventoryManager(String identifier) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome to Inventory Manager");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(36, 19, 390, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InventoryManager("exampleEmployeeID:SalesManager").setVisible(true);
            }
        });
    }
